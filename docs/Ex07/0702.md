...
1. Go to **Topics**, and open **Check Ticket Status**.
	...
	{: .note }
	> Our goal is to use Generative AI to draft a letter to the user based on the issue raise in the ServiceNow ticket
...
1. Add an **Input**, called **Ticket Details**. You will find 4 butons on the right hand side, the top one is the *input* button and it will open the dialog shown below.
