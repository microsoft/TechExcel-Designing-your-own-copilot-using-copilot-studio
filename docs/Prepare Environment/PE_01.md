...
1. On the taskbar for the @lab.VirtualMachine(Win11).SelectLink virtual machine, select **Windows PowerShell ISE**.
...
1. Wait until the script completes, checking the output in the bottom pane. 
    ...
    ![3d8lk1ym.jpg](instructions333077/3d8lk1ym.jpg)
